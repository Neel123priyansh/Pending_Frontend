              ...
              <tbody>
                <tr className="border-y text-[#00c78c] text-base font-semibold dark:border-green-600">
                  ...
                  <td className="pl-6 py-4 font-semibold text-[#00c78c]">
                    {price !== null ? `₹${total.toFixed(2)}` : "Calculating..."}
                  </td>
                </tr>
              </tbody>
              <tfoot>
                <tr className="text-[#00c78c]">
                  <th className="px-6 py-4 text-base">Total: {price !== null ? `₹${total.toFixed(2)}` : "Calculating..."}</th>
                  <td></td>
                  <td></td>
                  <td className="font-semibold px-6 py-3">Item in Cart: {amount}</td>
                  <td className="pl-6">
                    <button onClick={() => handleRazorpayScreen(total)} className="bg-green-700 rounded-md w-28 h-11 text-white">
                      CheckOut
                    </button>
                  </td>
                </tr>
